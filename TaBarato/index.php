...
<head>
    ...
    <link rel="stylesheet" href="TaBarato_inicial/style.css">
    <title>Tá Barato</title>
</head>
<body>
    <nav class="navbar">
        <div class="logo"><a href="#"><img src="TaBarato_inicial/img/img1.png" alt=""></a></div>
        <div class="log_reg">
    ...
    <header class="content">
        ...
        <div class="search-box">
            ...
            <button type="submit" class="btn">
                <img class="loupe-blue" src="TaBarato_inicial/img/loupe-blue.svg">
                <img class="loupe-white" src="TaBarato_inicial/img/loupe-white.svg">
            </button>
        </form>
        </div> 
    </header>
    <main class="products">
        ...
        <div class="recommend_products">
            <div class="p1">
                <div class="bana s">
                 <a href="busca.php?nome=Banana"><h3>Banana</h3></a>
                </div>
                <div class="caxi s">
                 <a href="busca.php?nome=Abacaxi"><h3>Abacaxi</h3></a>
                </div>
                <div class="feijao s">
                 <a href="busca.php?nome=Feijão"><h3>Feijão</h3></a>
                </div>
             </div>
             <div class="p2">
                 <div class="rango s">
